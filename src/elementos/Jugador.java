	...
	public int lucha(Jugador jugadorContrario) {
		...
		if(fuerzaDelJugador==fuerzaDelJugadorContrario) {
			...
			if(jugadorContrario.getPociones()>0) {
				...
				resultadoFinal=Constantes.GANA_DINERO;
				...
				if(pociones>0) {
					...
					jugadorContrario.dinero+= this.getDinero();
					this.dinero=0; 
					resultadoFinal= Constantes.PIERDE_DINERO;
					}else {
					resultadoFinal=Constantes.PIERDE_MUERE;				}
		}	
